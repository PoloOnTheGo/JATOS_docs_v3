...
keywords: Home page, welcome page, branding, customizing
tags:
summary:
sidebar: mydoc_sidebar
permalink: Customize-JATOS-Home-Page.html
folder:
toc: false
...
![template customized home page](images/screenshot-branding.png)
